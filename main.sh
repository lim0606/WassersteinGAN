...
python main.py --cuda --dataset mnist --dataroot /media/data0/image/mnist --imageSize 32 --nc 1 --niter 5000 --experiment samples/mnist_dcgan #2>&1 | tee logs/mnist_dcgan_$filename
